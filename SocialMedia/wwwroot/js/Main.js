...
var Main = (function () {
    ...
    Main.initialize = function (profile) {
        ...
        fullSizeImageModal = new FullSizeImageModal(document.getElementById('fullSizeImageModalContent'), document.getElementById('btnFullsizePrevious'), document.getElementById('btnFullsizeNext'), document.getElementById('imageCount'), document.getElementById('imageDateTime'), document.getElementById('fullsizeImageBox'), 'fullSizeImage');
        profileModal = new ProfileModal(document.getElementById('profileModal'), document.getElementById('profileNameWrapper'), document.getElementById('profileImages'), document.getElementById('profileBioWrapper'), document.getElementById('profileImagesWrapper'), document.getElementById('profileFriends'), document.getElementById('relationWrapper'), document.getElementById('profileModalPictureWrapper'), new ProfilePostsCard(document.getElementById('profilePostBoxes'), document.getElementById('btnToggleSearchBar'), document.getElementById('btnTogglePostFeedFilter'), document.getElementById('btnRefreshProfilePostFeed'), document.getElementById('btnMyPostActivity'), document.getElementById('btnSearchPosts'), document.getElementById('txtSearchPosts'), document.getElementById('commentedProfilePostsBox'), document.getElementById('likedProfilePostsBox'), document.getElementById('mainProfilePostsBox')), new ProfileSettingsCard(document.getElementById('profileSettings'), document.getElementById('btnToggleProfileSettings'), document.getElementById('profilePictureSetting'), document.getElementById('profileBioSetting'), document.getElementById('profileImagesSetting'), document.getElementById('profileFriendsSetting'), document.getElementById('profilePostsSetting'), document.getElementById('profileColorPalette'), document.getElementById('txtProfileColor'), document.getElementById('btnSetProfileColor')), 'profile-picture sqr', 'bio', 'name');
