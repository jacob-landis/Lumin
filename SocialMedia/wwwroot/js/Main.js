...
var Main = (function () {
    ...
    Main.initialize = function (profile) {
        ...
        profileModal = new ProfileModal(document.getElementById('profileModal'), document.getElementById('profileModalContent'), document.getElementById('profileNameWrapper'), document.getElementById('profilePostBoxes'), document.getElementById('commentedProfilePostsBox'), document.getElementById('likedProfilePostsBox'), document.getElementById('mainProfilePostsBox'), document.getElementById('profileImages'), document.getElementById('profileBioWrapper'), document.getElementById('profileModalPictureWrapper'), document.getElementById('profileImagesWrapper'), document.getElementById('profileFriends'), document.getElementById('btnTogglePostFeedFilter'), document.getElementById('btnRefreshProfilePostFeed'), document.getElementById('btnMyPostActivity'), 'profile-picture sqr', 'bio', 'name');
